  ...
  return (
    <div className='relative inline-block'>
      ...
      <div
        ...
        ref={ref}
        className='-top-2 data-[visible=true]:scale-100 data-[visible=true]:opacity-100 scale-0 delay-300 peer-hover:scale-100 min-w-full origin-bottom-right opacity-0  peer-hover:opacity-100 hover:opacity-100 hover:scale-100 transition-all duration-300 ease-in rounded-md backdrop-blur bg-opacity-50 bg-bg border-border border py-3 px-5 z-50 -translate-y-full right-0 absolute'
      >
        {content}
      </div>
    </div>
